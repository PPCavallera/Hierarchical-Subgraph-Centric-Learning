from lib.get_data_mtr import get_prepared_dataset, get_precise_cluster
...
if __name__ == "__main__":
    for c in range(NB_CLUSTER):
        df_c = get_precise_cluster(c) if NB_CLUSTER > 1 else get_precise_cluster(-1)
        ...
        save_loss_graphs(history_1, history_2, "loss_mtr_for_c"+str(c))
        get_test_loss(X_test, y_test, model_1, model_2, "mtr_cluster_"+str(c))
