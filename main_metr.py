from lib.get_data_metr_lstm import get_prepared_dataloader as get_prepared_dataloader_lstm, get_precise_cluster as get_precise_cluster_lstm, get_raw_data as get_raw_data_lstm, get_prepared_dataset as get_prepared_dataset_lstm
from lib.get_data_metr_dcrnn import get_prepared_dataloader as get_prepared_dataloader_dcrnn, get_raw_data as get_raw_data_dcrnn, get_precise_cluster  as get_precise_cluster_dcrnn, get_processed_data as get_processed_data_dcrnn
...
for i in range(len(Y_true[0])):
    ...
    ax.set_title('METR - Model comparison for node ' + str(i+1), fontsize=14)
    ...
    plt.savefig('METR_node'+str(i+1)+'.png')