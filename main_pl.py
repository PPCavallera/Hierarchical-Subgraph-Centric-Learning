from lib.get_data_pl import get_prepared_dataset, get_raw_data, get_precise_cluster
...
if __name__ == "__main__":
    ...
    for c in range(NB_CLUSTER):
        ...
        print('TRAINING TIME PL CLUSER ' + str(c))
        print("--- %s seconds ---" % (time.time() - start_time))
        save_loss_graphs(history_1, history_2, "loss_pl_for_c"+str(c))
        get_test_loss(X_test, y_test, model_1, model_2, "pl_cluster_"+str(c))
